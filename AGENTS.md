...
- Keep the deterministic workout fallback on the same enriched candidate selector used by LLM generation so difficulty, recency, force, mechanic, category, pattern, and variation diversity rules remain active when Groq is unavailable.
